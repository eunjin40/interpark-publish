            ...
            <div class="live-slide-item">
                <div class="live-tv">
                    <a href="${obj.live_info.url}">
                        <div class="live-tv-img">
                            <img src="${obj.live_info.image}" alt="" />
                        </div>
                        <div class="live-info">
                            <i>${obj.live_info.state}</i>
                            <div class="live-tv-name">
                                ${obj.live_info.title}
                            </div>
                        </div>
                        <div class="live-day">
                            <span>${obj.live_day.date}</span>
                            <b>${obj.live_day.time}</b>
                        </div>
                    </a>

                    <div class="live-good">
                        <a href="${
                          obj.live_good.good_url
                        }" class="live-good-inner">
                            <div class="live-good-img">
                                <img src="${obj.live_good.good_image}" alt="" />
                            </div>
                            <ul class="live-good-info">
                                <li>
                                    <p class="live-good-name">
                                        ${obj.live_good.good_title}
                                    </p>
                                </li>
                                <li>
                                    <span class="live-good-price">
                                        <b>${
                                          obj.live_good.good_discount &&
                                          obj.live_good.good_discount + "%"
                                        }</b>
                                        <em>${obj.live_good.good_price}</em>
                                        원
                                    </span>
                                </li>
                            </ul>
